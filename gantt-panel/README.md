...
## THIS IS A MODIFIED VERSION OF GANTT CHART DEVELOPED BY MARCUS OLSSON
The modifications are based on user needs. I removed dragging / zooming functionality and enabled select / copy of text in the tooltip.
