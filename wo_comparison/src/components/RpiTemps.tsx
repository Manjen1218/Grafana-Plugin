...
export const RpiTemps: React.FC<RpiTempsProps> = ({ workOrders, testStation }) => {
      ...
      try {
        ...
        for (const wo of workOrders) {
          const res = await fetch(
            `http://127.0.0.1:3000/api/rpi_temps?wo='${wo.woNumber}'&ts='${testStation}'&db=${wo.model}`
          );
          const json = await res.json();

          const jigResults: RpiTempData[] = json[0];
          ...
          jigResults.forEach((jig) => {
            ...
            const ave = jig.avg_rpi_temp;
            const max = jig.max_rpi_temp;
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <ReferenceLine
                ...
                strokeDasharray="4 4"
                label={{
                  value: `Avg Ave RPI Temp: ${averageAveTemp.toFixed(1)}°C`,
                  position: 'top',
                  fill: 'red',
                  fontSize: 12,
                }}
